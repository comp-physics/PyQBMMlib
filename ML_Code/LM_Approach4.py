...
LM_predictions = LM_Testing_Approach4(input_data,output_data,qbmm_LM,max_in,max_out,total_times,used_features,test_cases,cases,approach,output_dim,ml_dim,LM_QBMM,LM_MC, LM_pressure,lm_times,input_size)
if (cases == "constant"):
    ...
    sio.savemat('ML_Predictions/LM_Random_MLQBMM_Approach'+approach+'_Weights'+str(ml_dim//3)+'.mat',{'predictions':LM_predictions,'LM_MC':LM_MC,'LM_QBMM':LM_QBMM,'LM_pressure':LM_pressure,'input_data':input_data,'output_data':output_data,'max_in':max_in,'max_out':max_out})
