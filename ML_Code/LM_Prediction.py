...
from ML_Training  import LM_Testing_Approach1
...
cases = "random"
#cases = "sine";
output_data, qbmm_LM, max_out, total_cases, total_times, T, input_data, max_in, used_features, output_dim, ml_dim, LM_MC, LM_QBMM, LM_pressure, lm_times = Load_LM_Data_Output(cases,approach)
# Load QBMM data
...
LM_predictions = LM_Testing_Approach1(input_data,output_data,qbmm_LM,max_in,max_out,total_times,used_features,test_cases,cases,output_dim,LM_QBMM,LM_MC, LM_pressure,lm_times)
if (cases == "constant"):
    sio.savemat('ML_Predictions/LM_Random_MLQBMM_Approach1.mat',{'predictions':predictions})
elif (cases == "sine"):
    sio.savemat('ML_Predictions/LM_Random_MLQBMM_Approach1.mat',{'predictions':predictions,'input_data':input_data,'output_data':output_data})
elif (cases == "random"):
    sio.savemat('ML_Predictions/LM_Random_MLQBMM_Approach1.mat',{'predictions':LM_predictions,'LM_MC':LM_MC,'LM_QBMM':LM_QBMM,'LM_pressure':LM_pressure,'input_data':input_data,'output_data':output_data,'max_in':max_in,'max_out':max_out})
