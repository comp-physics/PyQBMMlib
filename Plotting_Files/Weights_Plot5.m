...
hold on
hp6 = plot(Weights_predictions(case_flag,2:3:15,tt),Weights_predictions(case_flag,3:3:15,tt),'o','Color',[0,0.5,1],'MarkerFaceColor',[0,0.5,1],'linestyle','none','Markersize',6);
text(1.61*(Rmax-Rmin)+Rmin,1.15*(Rdmax-Rdmin)+Rdmin,'QBMM Scheme','interpreter','latex','fontsize',16)
text(1.38*(Rmax-Rmin)+Rmin,1.05*(Rdmax-Rdmin)+Rdmin,'Weight \hspace{1.5cm} R-value \hspace{1.5cm} $\dot{R}$-value','interpreter','latex','fontsize',14)
...
hold on
hp8 = plot(Weights_predictions(case_flag,2:3:15,tt),Weights_predictions(case_flag,3:3:15,tt),'o','Color',[0,0.5,1],'MarkerFaceColor',[0,0.5,1],'linestyle','none','Markersize',6);
text(1.61*(Rmax-Rmin)+Rmin,1.15*(Rdmax-Rdmin)+Rdmin,'QBMM Scheme','interpreter','latex','fontsize',16)
text(1.38*(Rmax-Rmin)+Rmin,1.05*(Rdmax-Rdmin)+Rdmin,'Weight \hspace{1.5cm} R-value \hspace{1.5cm} $\dot{R}$-value','interpreter','latex','fontsize',14)
...
hold on
hp10 = plot(Weights_predictions(case_flag,2:3:15,tt),Weights_predictions(case_flag,3:3:15,tt),'o','Color',[0,0.5,1],'MarkerFaceColor',[0,0.5,1],'linestyle','none','Markersize',6);
text(1.61*(Rmax-Rmin)+Rmin,1.15*(Rdmax-Rdmin)+Rdmin,'QBMM Scheme','interpreter','latex','fontsize',16)
text(1.38*(Rmax-Rmin)+Rmin,1.05*(Rdmax-Rdmin)+Rdmin,'Weight \hspace{1.5cm} R-value \hspace{1.5cm} $\dot{R}$-value','interpreter','latex','fontsize',14)
...
hold on
hp14 = plot(Weights_predictions(case_flag,2:3:15,tt),Weights_predictions(case_flag,3:3:15,tt),'o','Color',[0,0.5,1],'MarkerFaceColor',[0,0.5,1],'linestyle','none','Markersize',6);
text(1.61*(Rmax-Rmin)+Rmin,1.15*(Rdmax-Rdmin)+Rdmin,'QBMM Scheme','interpreter','latex','fontsize',16)
text(1.38*(Rmax-Rmin)+Rmin,1.05*(Rdmax-Rdmin)+Rdmin,'Weight \hspace{1.5cm} R-value \hspace{1.5cm} $\dot{R}$-value','interpreter','latex','fontsize',14)
...
print(figeta,'-dpdf','Figures/Weights_Plot5.pdf');
savefig(figeta,'Figures/Weights_Plot5.fig');