...
load(['../ML_Code/ML_Predictions/LM_Random_MLQBMM_Approach1','.mat']);
total_cases = 30;
total_times = 20001;
...
print(figeta,'-dpdf','Figures/LM_Random_Forcing_Results_Approach1.pdf');
savefig(figeta,'Figures/LM_Random_Forcing_Results_Approach1.fig');
